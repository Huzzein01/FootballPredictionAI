...
async function main() {
  ...
  fs.writeFileSync(manifestPath, JSON.stringify({ contract: "football-history-raw-manifest-v1", provider: "RSSSF", generatedAt: new Date().toISOString(), scope: "Coppa Italia historical archive through the main archive page", rows: [{ url, captured: true, retrievedAt: new Date().toISOString(), sha256, file }] }, null, 2) + "\n");
