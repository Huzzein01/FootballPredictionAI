...
const rows = Array.isArray(inputData) ? inputData : inputData.rows;
if (!Array.isArray(rows)) throw new Error("Training input must be an array of rows or a dataset object with rows");
